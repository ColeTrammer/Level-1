 ...
 // 1. Make a JFrame variable 
	JFrame frame;
	 ...
	 // 2. add 4 images which match keyboard keys like this: images.put(new Integer(KeyEvent.VK_UP), "image.jpg");
	  	images.put(new Integer(KeyEvent.VK_H), "H.png");
	  	images.put(new Integer(KeyEvent.VK_B), "B.png");
	  	images.put(new Integer(KeyEvent.VK_R), "R.png");
	  	images.put(new Integer(KeyEvent.VK_K), "K.png");
